  ...
  useEffect(() => {
    const typing = () => {
      if (index < fullText.length) {
        ...
        }, 5000); // Задержка перед перезапуском
      }
    };
  ...
  return (
    <div className="ventilation-container">
      <div
        ...
        style={{
          backgroundImage:
            'url("https://optim.tildacdn.com/tild3434-6134-4736-b865-623333616463/-/format/webp/bg_calculator.jpg")',
          backgroundSize: "cover", // Масштабирование изображения
          backgroundPosition: "center", // Центрирование изображения
          backgroundAttachment: "scroll", // Поведение при прокрутке
        }}
      >
        <div
          data-hook-content="covercontent"
          className="ventilation-cover__content"
        >
